...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/28 19:30:25 by javiersa          #+#    #+#             */
/*   Updated: 2023/03/08 19:45:29 by javiersa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
*	@brief		Checks for an imprimible/control ASCII character (0 - 127).
*
*	@param		c	Character to check.
*
*	@return		1 if c is an imprimible/control ASCII character, 0 otherwise.
*/
int		ft_isascii(int c);

/*
*	@brief		Checks for any printable character including space (32 - 126).
*
*	@param		c	Character to check.
*
...
/*
*	@brief	The printf function (the name comes from “print formatted”) prints a
string on the screen using a “format string” that includes the instructions to
mix several strings and produce the final string to be printed on the screen.
*
*	@param		*str	The string.
*	@param		*...	The format, it can be %c, %s, %d, % i, %u, %x, %X, %p or %% .
*
*	@return		The number of characters you have typed.
*/
...
/*
*	@brief	It is a function that reads a file and allows you to read a line
ending with a newline character from a file descriptor. When you call the
function again on the same file, it grabs the next line.
*
*	@param		fd	The file director
*
*	@return		The number of characters you have typed.
*/
